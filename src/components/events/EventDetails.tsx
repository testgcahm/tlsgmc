...
const EventInfoCard = ({ event, sanitize }: { event: EventData; sanitize: (input: string) => string }) => (  <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl border border-neutral-dark/20 p-6 max-[475px]:p-4 hover:shadow-2xl transition-all duration-300">
    <div className="flex items-center gap-3 mb-6 max-[475px]:mb-4">
      ...
      <h3 className="text-2xl max-[600px]:text-xl max-[475px]:text-lg font-bold bg-gradient-to-r from-primary to-primary-light bg-clip-text text-transparent break-all">
        Event Details
      </h3>      </div>      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 max-[475px]:gap-1 mb-4 max-[475px]:mb-3">
      <motion.div
      ...
      >
        <div className="flex items-center gap-3 max-[475px]:gap-2">          
          ...
          <div>
            <span className="text-sm max-[600px]:text-xs max-[475px]:text-xs font-medium text-primary-light/80 uppercase tracking-wider break-all">Date</span>
            <p className="text-lg max-[600px]:text-base max-[475px]:text-sm font-bold text-primary break-all">{event.date}</p>
          </div>
        </div>
      ...
      >
        <div className="flex items-center gap-3 max-[475px]:gap-2">
          ...
          <div>
            <span className="text-sm max-[600px]:text-xs max-[475px]:text-xs font-medium text-primary-light/80 uppercase tracking-wider break-all">Time</span>
            <p className="text-lg max-[600px]:text-base max-[475px]:text-sm font-bold text-primary break-all">{event.time}</p>
          </div>
        </div>
      </motion.div>
      <motion.div
      ...
      >
        <div className="flex items-center gap-3 max-[475px]:gap-2">
          ...
          <div>
            <span className="text-sm max-[600px]:text-xs max-[475px]:text-xs font-medium text-primary-light/80 uppercase tracking-wider break-all">Venue</span>
            <p className="text-lg max-[600px]:text-base max-[475px]:text-sm font-bold text-primary break-all">{event.venue}</p>
          </div>
        </div>
      </motion.div>      <motion.div
        className="bg-gradient-to-br from-neutral to-neutral-light p-3 max-[475px]:p-2 rounded-xl border border-neutral-dark/20 shadow-sm"
      >
        <div className="flex items-center gap-3 max-[475px]:gap-2">
          ...
          <div>
            <span className="text-sm max-[600px]:text-xs max-[475px]:text-xs font-medium text-primary-light/80 uppercase tracking-wider break-all">Audience</span>
            <p className="text-lg max-[600px]:text-base max-[475px]:text-sm font-bold text-primary break-all">{event.audience}</p>
          </div>
        </div>
      </motion.div>    </div>    <div className="space-y-4 max-[475px]:space-y-3">
      <motion.div
      ...
      ><div className="flex items-center gap-3 max-[475px]:gap-2 mb-2 max-[475px]:mb-1">
          <div className="bg-gradient-to-br from-accent to-accent-dark p-2.5 max-[475px]:p-2 rounded-lg shadow-md">
            ...
            </svg>        </div>        <span className="text-xl max-[600px]:text-lg max-[475px]:text-base font-bold bg-gradient-to-r from-primary to-primary-light bg-clip-text text-transparent break-all">Activities</span>
        </div>
        <div className="bg-gradient-to-br from-neutral-light to-white border border-neutral-dark/20 rounded-xl p-3 max-[475px]:p-2 shadow-inner">
          <div className="text-primary-light max-[600px]:text-sm max-[475px]:text-xs leading-relaxed break-all" dangerouslySetInnerHTML={{ __html: sanitize(event.activities.replace(/\n/g, '<br />')) }} />
        </div>
      </motion.div><motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ delay: 0.3 }}      >        <div className="flex items-center gap-3 max-[475px]:gap-2 mb-2 max-[475px]:mb-1">
          ...
          <span className="text-xl max-[600px]:text-lg max-[475px]:text-base font-bold bg-gradient-to-r from-primary to-primary-light bg-clip-text text-transparent break-all">Description</span>
        </div>
        <div className="bg-gradient-to-br from-neutral-light to-white border border-neutral-dark/20 rounded-xl p-3 max-[475px]:p-2 shadow-inner">
          <div className="text-primary-light max-[600px]:text-sm max-[475px]:text-xs leading-relaxed break-all" dangerouslySetInnerHTML={{ __html: sanitize(event.description.replace(/\n/g, '<br />')) }} />
        </div>
      </motion.div>
    </div>
  </div>
...
const EventSegments = ({ subevents, sanitize, setEnlargedImage }: {
  ...
  <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl border border-neutral-dark/20 p-6 max-[475px]:p-4 hover:shadow-2xl transition-all duration-300">
    <div className="flex items-center gap-3 max-[475px]:gap-2 mb-6 max-[475px]:mb-4">
      ...
      <h3 className="text-2xl max-[600px]:text-xl max-[475px]:text-lg font-bold bg-gradient-to-r from-primary to-primary-light bg-clip-text text-transparent break-all">
        Event Segments
      </h3>      </div>    <div className="space-y-4 max-[475px]:space-y-3">
          ...
          className="bg-gradient-to-br from-neutral-light to-white border border-neutral-dark/20 rounded-2xl p-4 max-[475px]:p-3"        ><div className="flex flex-col lg:flex-row gap-4 max-[475px]:gap-3">
            {sub.imageUrl && (              <div className="flex-shrink-0 group">
              ...
              <div className="flex items-center gap-3 max-[475px]:gap-2">
                ...
                <span className="text-sm max-[600px]:text-xs max-[475px]:text-xs font-bold text-accent bg-accent/10 px-3 max-[475px]:px-2 py-1 rounded-full break-all">{sub.time}</span>
              </div>

              <h4 className="text-xl max-[600px]:text-lg max-[475px]:text-base font-bold bg-gradient-to-r from-primary to-primary-light bg-clip-text text-transparent break-all">
                {sub.title}
              </h4>              {sub.description && (
                <div className="bg-gradient-to-br from-neutral to-neutral-light rounded-xl p-3 max-[475px]:p-2 border border-neutral-dark/20">
                  <div className="text-primary-light max-[600px]:text-sm max-[475px]:text-xs break-all leading-relaxed" dangerouslySetInnerHTML={{ __html: sanitize(sub.description.replace(/\n/g, '<br />')) }} />
                </div>
              )}
            </div>
          </div>          {sub.speakers && sub.speakers.length > 0 && (
            <div className="bg-white rounded-xl mt-3 max-[475px]:mt-2 p-3 max-[475px]:p-2 border border-neutral-dark/20 shadow-sm">
              <div className="flex items-center gap-2 max-[475px]:gap-1 mb-2 max-[475px]:mb-1">
                ...
                <span className="font-bold max-[600px]:text-sm max-[475px]:text-xs text-primary break-all">Speakers</span>
              </div>
              <div className="space-y-2 max-[475px]:space-y-1">{sub.speakers.map((sp: any, i: number) => (
                  <div key={i} className="bg-gradient-to-r from-neutral to-neutral-light p-2 max-[475px]:p-1.5 rounded-lg border border-neutral-dark/20">
                    <span className="font-bold max-[600px]:text-sm max-[475px]:text-xs text-primary block break-all">{sp.name}</span>
                    {sp.bio && <span className="text-sm max-[600px]:text-xs max-[475px]:text-xs text-primary-light mt-1 block break-all">{sp.bio}</span>}
                  </div>
                ))}
              </div>
            </div>
      ...
      {speakers.map((speaker: { name: string; bio?: string }, idx: number) => (
        ...
        ><div className="flex items-start gap-3 max-[475px]:gap-2">
            ...
            <div className="flex-1">
              <h4 className="font-bold text-primary text-lg max-[600px]:text-base max-[475px]:text-sm mb-1 max-[475px]:mb-0 break-all">{speaker.name}</h4>
              {speaker.bio && (
                <p className="text-primary-light max-[600px]:text-sm max-[475px]:text-xs leading-relaxed break-all">{speaker.bio}</p>
              )}
            </div>
          </div>
        </motion.div>
