...
export default function AdminAccessDenied({ userEmail, handleLogout }: { userEmail: string | null; handleLogout: () => void }) {
  return (
    <div className='flex flex-col items-center justify-center min-h-[80vh] bg-gray-100'>
      <h1 className="text-2xl text-accent font-bold mb-4">Access Denied</h1>
      ...
      <button
        className="bg-accent hover:bg-accent-light text-white font-bold px-3 py-[6px] mt-1 rounded shadow-sm transition-all duration-200 focus:outline-none flex items-center gap-3 mb-2"
